    ...
    public class MessageReceiver : ClientEntity, IMessageReceiver
    {
            ...
            Func<Message, CancellationToken, Task> callback)
        {
            ...
            lock (this.messageReceivePumpSyncLock)
            {
                ...
                this.receivePump = new MessageReceivePump(this, registerHandlerOptions, callback, ServiceBusConnection.NamespaceName, this.receivePumpCancellationTokenSource.Token);
            }

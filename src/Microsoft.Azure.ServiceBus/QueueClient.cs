...
namespace Microsoft.Azure.ServiceBus
{
    ...
    public class QueueClient : ClientEntity, IQueueClient
    {
        ...
        /// <summary>
        /// Creates a new instance of the Queue client using the specified endpoint, entity path, and AAD authentication context.
        /// </summary>
        /// <param name="endpoint">Fully qualified domain name for Service Bus. Most likely, {yournamespace}.servicebus.windows.net</param>
        /// <param name="entityPath">Queue path.</param>
        ...
        public QueueClient(
            ...
            ReceiveMode receiveMode = ReceiveMode.PeekLock,
            RetryPolicy retryPolicy = null)
            : this(endpoint, entityPath, TokenProvider.CreateAadTokenProvider(authContext, clientCredential), transportType, receiveMode, retryPolicy)
        {
        }
        ...
        public QueueClient(
            ...
            ReceiveMode receiveMode = ReceiveMode.PeekLock,
            RetryPolicy retryPolicy = null)
            : this(endpoint, entityPath, TokenProvider.CreateAadTokenProvider(authContext, clientId, redirectUri, platformParameters, userIdentifier), transportType, receiveMode, retryPolicy)
        {
        }
        ...
        public QueueClient(
            ...
            ReceiveMode receiveMode = ReceiveMode.PeekLock,
            RetryPolicy retryPolicy = null)
            : this(endpoint, entityPath, TokenProvider.CreateAadTokenProvider(authContext, clientAssertionCertificate), transportType, receiveMode, retryPolicy)
        {
        }
#endif

        /// <summary>
        /// Creates a new instance of the Queue client using the specified endpoint, entity path on Azure Managed Service Identity authentication.
        /// </summary>
        /// <param name="endpoint">Fully qualified domain name for Service Bus. Most likely, {yournamespace}.servicebus.windows.net</param>
        /// <param name="entityPath">Queue path</param>
        /// <param name="transportType">Transport type.</param>

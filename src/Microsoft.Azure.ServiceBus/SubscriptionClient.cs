...
namespace Microsoft.Azure.ServiceBus
{
    ...
    public class SubscriptionClient : ClientEntity, ISubscriptionClient
    {
        ...
        /// </remarks>
        public Task DeadLetterAsync(string lockToken, string deadLetterReason, string deadLetterErrorDescription = null, IDictionary<string, object> propertiesToModify = null)
        {
            this.ThrowIfClosed();
            return this.InnerSubscriptionClient.InnerReceiver.DeadLetterAsync(lockToken, deadLetterReason, deadLetterErrorDescription, propertiesToModify);
        }
